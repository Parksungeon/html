...
// console.log(smaple1Instance.staticPublicField);
...
/*
    인스턴스 메서드와 정적 메서드 : 
    - 클래스 내부에 frunction 키워드를 제거한 함수를 작성하여 인스턴스 메서드 작성 선언
...
const child2Instane = new Child2Class();
console.log(child2Instane.parentField);
console.log(child2Instane.child2Field);
child2Instane.parentMethod();
